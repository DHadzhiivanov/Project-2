...
label = tk.Label(window, text="This is a cipher tool", font="Arial,20", bg="white")
...
def open_new_window():
    ...
    new_label = tk.Label(new_window, text="Insert your key here:", font="Arial,20", bg="white")
    ...
    submit_button = tk.Button(new_window, text="Submit", command=on_submit, font="Arial,12", bg="white")
...
# Buttons
encrypt_button = tk.Button(window, command=on_encrypt, text="Encrypt", font="Arial, 12", bg="white")
encrypt_button.pack(side=tk.TOP, pady=10)

decrypt_button = tk.Button(window, command=on_decrypt, text="Decrypt", font="Arial, 12", bg="white")
decrypt_button.pack(side=tk.BOTTOM, pady=10)

set_key_button = tk.Button(window, command=open_new_window, text="Set Key", font="Arial, 12", bg="white")
set_key_button.pack(pady=10)
clear_button = tk.Button(window, command=clear_text_boxes, text="Clear", font="Arial, 12", bg="white")
